 ...
 * regular old apache HttpClient/HttpContext if you prefer.</p>
 * 
 * <p>Changed by Yogu.</p>
 */
public class PersistentCookieStore implements CookieStore {
    ...
    public void save(Context context) {
      ...
      for (Cookie cookie : cookies.values()) {
        ...
        prefsWriter.putString(COOKIE_NAME_PREFIX + cookie.getName(), encodeCookie(new SerializableCookie(cookie)));
      }
